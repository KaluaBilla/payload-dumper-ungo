// This header is taken from https://github.com/KaluaBilla/sha256
 ...
 * After calling this, the context is invalid and must be reinitialized
 * 
...
static inline void sha256_final(SHA256_CTX *ctx, uint8_t hash[SHA256_DIGEST_SIZE])
{
    ...
    /* Add padding through normal update mechanism */
